...
const modules = [
  ['Gate & weighbridge', 'Capture every truck, weight, and quality check at the source.'],
  ['Saudās & khata', 'Keep purchase and sales agreements, payments, and balances together.'],
  ['Live stock', 'Follow each lot from paddy arrival through processing and dispatch.'],
  ['Daily mass balance', 'See unexplained loss before it becomes a season-end surprise.'],
];
